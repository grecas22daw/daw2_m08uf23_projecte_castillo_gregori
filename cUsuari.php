...
<form action="./cUsuari.php" method="POST">
UID: <input type="text" name="uid"><br>
UO: <input type="text" name="uo"><br>
uid: <input type="number" name="uid_num"><br>
gid: <input type="number" name="gid_num"><br>
DP: <input type="text" name="directori"><br>
...
CP: <input type="text" name="postal"><br>
